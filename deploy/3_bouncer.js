module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const DISPATCHER_MAX_BANKROLL_REQUESTABLE = process.env.DISPATCHER_MAX_BANKROLL_REQUESTABLE
  ...
  const deployResult = await deploy("Bouncer", {
    ...
    contract: "Bouncer",
    gas: 4000000,
    args: [dispatcherFactory.address, VOTING_POWER_PRISM_ADDRESS, GLOBAL_MAX_CONTRIBUTION_PCT, DISPATCHER_MAX_CONTRIBUTION_PCT, DISPATCHER_MAX_BANKROLL_REQUESTABLE, BANKROLL_REQUIRED_VOTING_POWER, DISPATCHER_FACTORY_ADMIN_ADDRESS, DISPATCHER_FACTORY_ROLE_ADMIN_ADDRESS, true],
